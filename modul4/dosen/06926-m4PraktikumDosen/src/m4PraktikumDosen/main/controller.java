...
public class controller extends biaya{
    public static ArrayList<kendaraan> list = new ArrayList<kendaraan>();
    int ongkosh=0;
...
//    }
    public void tambahParkir(String plat,String tanggal,int waktuMasuk,int waktuKeluar,int harga){
        kendaraan motor=new kendaraan(plat,tanggal,waktuMasuk,waktuKeluar,harga);
        list.add(motor);
    }
